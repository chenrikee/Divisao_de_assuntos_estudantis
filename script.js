...
const url_remoto = "https://divisao-de-assuntos-estudantis.vercel.app/";
...
insertBtn.addEventListener('click', async () => {
    ...
    try {
        const response = await fetch(url_remoto+'cadastro', {
            method: 'POST',
            headers: {
...
async function loadUsers() {
    try {
        const response = await fetch(url_remoto+'/usuarios');
        if (response.ok) {
